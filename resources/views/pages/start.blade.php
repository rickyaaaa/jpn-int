<x-layouts.app title="Mulai Tes - Japanese Interview AI">
    <section class="min-h-[calc(100vh-73px)] bg-zinc-950 px-4 py-10 text-white sm:px-6 lg:px-8">
        <div class="mx-auto grid max-w-6xl items-center gap-6 lg:grid-cols-[minmax(0,1fr)_420px]">
            <div class="space-y-5">
            ...
            <form method="POST" action="{{ route('candidate.login') }}" class="rounded-lg border border-white/10 bg-white/[0.08] p-6 shadow-2xl shadow-black/30 backdrop-blur sm:p-8">
                ...
                <button class="mt-6 inline-flex w-full items-center justify-center gap-2 rounded-md bg-teal-500 px-5 py-3 text-sm font-bold text-zinc-950 transition hover:bg-teal-300 focus:outline-none focus:ring-4 focus:ring-teal-400/20" type="submit">
